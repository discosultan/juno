...
def test_macd() -> None:
    ...
    outputs = [
        [  # MACD.
            ...
            '-0.192932945', '-0.451916620', '-0.912958472', '-1.124556845', '-1.268899802',
        ...
        [  # Signal.
            ...
            '-0.077060132', '-0.152031429', '-0.304216838', '-0.468284839', '-0.628407832',
        ...
        [  # Histogram.
            ...
            '-0.115872813', '-0.299885190', '-0.608741634', '-0.656272006', '-0.640491970',
