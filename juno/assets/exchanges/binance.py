...
from juno.assets.models import AssetInfo, BorrowInfo, ExchangeInfo, Fees, Ticker
from juno.exchanges.binance import SEC_USER_DATA
from juno.exchanges.binance import Binance as Session
from juno.exchanges.binance import from_symbol, to_http_symbol
...
class Binance(Exchange):
    ...
    async def get_exchange_info(self) -> ExchangeInfo:
        ...
        fees_ret, filters_ret, isolated_pairs, margin_ret, isolated_ret = await asyncio.gather(
            self._session.api_request('GET', '/sapi/v1/asset/tradeFee', security=SEC_USER_DATA),
            self._session.api_request('GET', '/api/v3/exchangeInfo', weight=10),
